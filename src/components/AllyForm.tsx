...
const formSchema = z.object({
    ...
    seed: z
        .string()
        .min(200, { message: 'Seed require atleast 200 characters' }),
                    ...
                    <div className="space-y-2 w-full">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                General information about your ally
                            </p>
                        </div>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    Describe in detail your ally&apos;s
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    Provide a sample conversation with your ally
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
